...
def text_to_speech(text, file_name='speech.mp3'):
    ...
    response = polly_client.synthesize_speech(
        ...
        VoiceId='Lucia'    # The voice ID to use (Polly supports multiple voices; 'Joanna' is a female US English voice).
    )
...
text = "Me llamo Andy."  # The text you want to convert to speech.
